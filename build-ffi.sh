...
#   and the branch comparePoseidon2ToLean checked out
#   and located at ../Plonky3 (relative to this script).
#
...
echo ""
echo "To run an example via FFI:"
echo "  lake exe Tests.FFI"
echo ""
echo "To run property based tests comparing the Rust version (via FFI) to pure Lean:"
echo "  lake exe Tests.Poseidon2"
